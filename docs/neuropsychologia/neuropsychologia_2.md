...
### Przejęcie funkcji w przypadku uszkodzeń jednostronnych
...
### Kształtowanie asymetrii półkulowej
...
### Rozwiązanie: Mapy przybierające różne funkcje
...
- Pewne obszary są **najbardziej wydajne** w określonych obliczeniach ze względu na:
  ...
  - Powiązanie z innymi strukturami (percepcja, funkcje motoryczne)
- Te obszary stanowią **lepszy zasób** do przydzielenia dla danej funkcji

**Aktywne przydzielanie zasobów:** Funkcje lokują się w obszarach, które mogą je **najpełniej realizować**
...
### Wyodrębnienie objawu dominującego
...
**Wniosek:** Struktury 1 i 2 są wyspecjalizowane w różnych funkcjach (A i B)
...
### Neuropsychologia procesu - perspektywa czasowa

**Założenie:** Procesy psychiczne rozwijają się **w czasie** (mikro- i makrogeneza)

**Przykład - rozwój spostrzegania przedmiotu:**

```
Wrażenie niezróżnicowane
    ↓
Percepcja całości
    ↓
Analiza elementów
...
4. **Synteza** (właściwości)
5. **Rozpoznanie** (identyfikacja obiektu)
...
**Relacja:** Pojęcia **świadomości** i **samoświadomości** są ze sobą powiązane i przenikające się

---

### Świadomość według Browna

**Relacja:** JA ↔ OBIEKT ↔ REPREZENTACJA W MÓZGU
...
### Pojedynczy stan umysłowy (Damasio, LeDoux)
...
- Reprezentacja obiektu w głowie
...
**Definicja:** Skupienie się na określonym zadaniu z wykluczeniem innych bodźców

**Mechanizm:** To, że **na coś patrzymy** = koncentracja

---

#### 3. Sterowanie (meta-uwaga)
...
### Systemowy model procesów uwagi (Posner, Petersen)
...
### 3 typy bodźców kierujących uwagą

**Ontogeneza + Filogeneza:**

#### 1. Bodźce ważne dla przetrwania

**Struktury:** Pień mózgu, twór siatkowaty

**Regulacja:** Podstawowe mechanizmy przetrwania

---

#### 2. Bodźce ciekawe lub związane z emocjami
...
**Komponent:** Odpowiedzi emocjonalne

---

#### 3. Bodźce ważne ze względu na wyznaczony cel
...
**Proces rozwijający się w czasie:**
Wrażenie → Percepcja całości → Analiza → Synteza → Rozpoznanie

**Zaburzenia:** Różne choroby → różne zaburzenia percepcji czasu (przykład: schizofrenia → nadmierna uwaga na przyszłość)

---

### 🔑 Świadomość

**Definicja:** Stan psychiczny - zdawanie sobie sprawy z własnych procesów i otaczającego świata
...
**Relacja:** Selektywność i koncentracja = procesy przeciwstawne
...
- Pojedynczy stan umysłowy (składniki)
- Percepcja: ogół → szczegół (nie odwrotnie!)
- "Widzimy to, co chcielibyśmy zobaczyć"
...
- Uwaga a model świata
- 2 typy procesów (automatyczne, świadome)
- 4 systemy uwagi (struktury, funkcje)
- Efekt koktajl party
- 3 typy bodźców (perspektywa ewolucyjna)
