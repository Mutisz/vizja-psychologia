...
### Perspektywa czasowa w neuropsychologii
...
### 2 podejścia do podziału kory

#### A. Podejście strukturalne (cytoarchitektoniczne)
...
- Nawet 1000+ obszarów (jeśli bardzo dokładnie patrzeć na subpopulacje komórek)

---

#### B. Podejście funkcjonalne

**Kryterium:** Funkcja pełniona przez dane obszary kory
...
### Klasyfikacja funkcjonalna kory (według Mesulama)
...
4. Korzystają z **kleju promienistego** (długie komórki glejowe) – "wspinają się" po nich
5. Klej promienisty wydłuża się, obejmując całą korę
6. Neurony migrują kolejno do warstw: **VI → V → IV → III → II → I**

**Zaburzenia migracji** → zaburzenia rozwojowe u pacjentów

---

### Zgodność podziału strukturalnego i funkcjonalnego

**Ważna obserwacja:** Podział strukturalny według Brodmana **częściowo pokrywa się** z funkcjami pełnionymi przez dane obszary
...
4. **5 wtórnych pęcherzyków mózgowych** – różnicowanie pierwotnych
5. **Poszczególne części mózgowia** – z wtórnych pęcherzyków
...
### Model hierarchiczny Aleksandra Łurii (1967, 1976)

**3 bloki funkcjonalne mózgu:**

#### **Blok 1: Energetyczny (blok podporowy)**
...
**Składniki:** Kory czuciowe i ruchowe

---

#### **Blok 3: Planowania i kontroli**

**Składniki:** Struktury płata czołowego

**Funkcja:** Planowanie i kontrola funkcjonowania bloku informacyjnego

---

### Przepływ informacji w modelu Łurii

```
Bodźce sensoryczne (narządy zmysłów)
    ↓
Kora pierwszorzędowa (sensoryczna)
    ↓
Kora drugorzędowa
    ↓
Kora trzeciorzędowa (blok informacyjny)
    ↓ [Energetyzacja przez blok 1]
Przetwarzanie na intencje (trzeciorzędowe pola ruchowe)
    ↓
Realizacja wzoru działania (drugorzędowe i pierwszorzędowe pola ruchowe)
    ↑ [Nadzór przez blok 3 - planowanie i kontrola]
```

**Model hierarchiczny:** Zakłada **jednokierunkowe** połączenia między korami (pierwszorzędowa → drugorzędowa → trzeciorzędowa)
...
### Koncepcja systemów funkcjonalnych

**Założenie:** Zamiast pojedynczych obszarów, wyróżniamy **większe systemy** współpracujące ze sobą

**Perspektywa neuropsychologiczna:** Spojrzenie funkcjonalne na współpracę różnych struktur
...
**Wyjście:** Funkcje motoryczne (mowa, reakcje, działania)

---

### Neuromodulacja systemów
...
### Analogia obliczeniowa

**Systemy funkcjonalne mózgu ≈ systemy informatyczne:**

- **Wejścia** (klawiatura, obraz wideo) → **narządy zmysłów**
- **Procesy obliczeniowe** → **przetwarzanie w mózgu**
...
### Mechanizmy reorganizacji funkcjonalnej
...
- Nieuszkodzone obszary **podejmują pracę**

**Rezultat:** Zmniejszenie/ustąpienie części objawów
...
#### 3. Teoria redundancji (reduplikacji)
...
### Plastyczność po udarze mózgu

#### Penumbra (strefa półcienia)
...
- Penumbra może zanikać, ale też nasilać się w czasie
...
#### 1. Przywracanie/odbudowa/reaktywacja
...
**Ocena:** Podejście intuicyjne i pożądane
...
### 3 okresy plastyczności (przez całe życie)

#### **Okres 1: Plastyczność rozwojowa**
...
#### **Okres 2: Ustalanie repertuaru sprawności**
...
#### **Okres 3: Plastyczność kompensacyjna**
...
- Aktualizacja zasobów pamięciowych
...
### 🔑 Neuropsychologia - podstawy

**Definicja:** Nauka z pogranicza medycyny i psychologii
...
4. Zastępcze funkcje
5. Substytucja
6. Przejęcie funkcji (lateralizacja)

**Penumbra:** Strefa niedokrwienna wokół udaru

**Nowe zdolności:** Reorganizacja może prowadzić do nowych funkcji (przykład: pacjentka-muzyk → malarstwo)

---

### 🔑 3 okresy plastyczności

**Okres 1** (~0-4 lata): Model świata, funkcje zmysłowe i ruchowe

**Okres 2** (~dzieciństwo, do 8-10 lat): Repertuar sprawności, motoryka, okresy krytyczne (ekspozycja na mowę, interakcje)

**Okres 3** (~5 lat → śmierć): Plastyczność kompensacyjna, model umysłu, aktualizacja pamięci
...
- Budowa kory nowej (6 warstw, kolumny)
- Hipoteza jednostek promienistych (Rakić)
...
- Diaschiza, penumbra
- Nowe zdolności po uszkodzeniu
- 3 okresy plastyczności w życiu
