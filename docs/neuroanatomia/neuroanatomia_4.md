...
**Definicja:** Wypuklenia pajęczynówki do zatok opony twardej
...
- Łączy się baleczkami z oponą pajęczą
- Ogranicza przestrzeń podpajęczynówkową od dołu
...
## 2. PŁYN MÓZGOWO-RDZENIOWY (CSF) - PARAMETRY
...
**Lokalizacja:** Grzbietowa powierzchnia pnia mózgu

**Funkcja:** CSF z komory IV → przestrzeń podpajęczynówkowa → wchłanianie do zatok

**Zawartość:** **Splot naczyniówkowy** (podobny do komory III)
...
- Zachyłek boczny
- Zachyłek wierzchołka
- **Komora Arancjusza** – przy ujściu komory IV do kanału środkowego rdzenia

---

### Zbiorniki przestrzeni podpajęczynówkowej

**Miejsca rozszerzenia przestrzeni podpajęczynówkowej:**

- Zbiornik bruzdy bocznej (bruzda boczna)
- Zbiornik okalający (otacza pień mózgu)
- Zbiornik skrzyżowania (okolica skrzyżowania nerwów wzrokowych)
- Zbiornik międzykonarowy (dół międzykonarowy)
- **Zbiornik lędźwiowy** – otacza stożek rdzeniowy i ogon koński

---

## 4. MÓŻDŻEK (CEREBELLUM)
...
- **Istota biała:** Głęboko w półkulach, tworzy **konary móżdżku**
...
### Podział czynnościowy (filogenetyczny)
...
- **Droga móżdżkowo-przedsionkowa** – łączy móżdżek ze śródmózgowiem i jądrami przedsionka

---

### Funkcje móżdżku

**Tradycyjne (motoryczne):**
...
### Ciekawostka: Móżdżek a wiek

- U **100-latków:** Móżdżek jest o **~15 lat młodszy** niż oczekiwany wiek biologiczny (biomarkery)
- Móżdżek = **"najmłodsza część mózgowia"** w procesie starzenia

---

## 5. KRES MÓZGOWIA (TELENCEPHALON) - BUDOWA ZEWNĘTRZNA
...
### 5 płatów mózgu (na każdej półkuli)

1. **Płat czołowy** (lobus frontalis)
2. **Płat ciemieniowy** (lobus parietalis)
3. **Płat potyliczny** (lobus occipitalis)
4. **Płat skroniowy** (lobus temporalis)
5. **Płat wyspowy** (lobus insularis) – **ukryty**, głęboko

---

## 6. PŁATY MÓZGU - SZCZEGÓŁY
...
**Lokalizacja:** Głęboko na styku płatów: skroniowego, ciemieniowego, czołowego

**Ukryty:** Pod płatem skroniowym (trzeba odsunąć/obciąć płat skroniowy)
...
- Bruzda okalająca wyspy
- Próg wyspy

**Funkcja:** Kontrola procesów **artykulacyjnych**
...
⚠️ **Neokortex** występuje **wyłącznie u ssaków**
...
**Liczba pól u człowieka:** **44**

❗ Pola o numerach **13-16** i **48-51** nie występują

---

### Lokalizacja i funkcje wybranych pól

**Każde pole = konkretna lokalizacja + konkretna funkcja**
...
#### Ośrodek Broca (pole 44)

**Lokalizacja:** Zakręt czołowy dolny (część trójkątna)  
**Unaczynienie:** **Tętnica środkowa mózgu**  
...
- Rozumienie mowy: **zachowane** (ale trudniejsze sformułowania gorsze)

---

#### Ośrodek Wernicke'go (pole 22)

**Lokalizacja:** Zakręt skroniowy górny (część tylna)  
**Unaczynienie:** **Tętnica środkowa mózgu**  
...
- Mowa niezrozumiała ("bełkot")
- **Niska świadomość** popełnianych błędów (pacjent myśli, że mówi dobrze)

---

## 9. ZABURZENIA KORY MÓZGOWEJ
...
## 10. PÓŁKULA DOMINUJĄCA VS NIEDOMINUJĄCA
...
- Niemożność rysowania prostych rysunków
- Zaburzenia odbioru rytmu słów, akcentu
...
**1. Niemożność porównywania przedmiotów** trzymanych w obu rękach bez zobaczenia
...
4. Skroniowy (pod bruzdą boczną)
5. Wyspowy (ukryty, głęboko)

---

### 🔑 Pola Brodmana i mowa
...
- Funkcje (tradycyjne + nowe)
- Zespoły: robaka przedniego, półkulowy
...
- Afazje (ekspresyjna vs recepcyjna)
